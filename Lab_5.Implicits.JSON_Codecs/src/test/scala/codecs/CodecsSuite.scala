...
//  /** Custom Test for variant 23 */
//  @Test def `a 'Student' value should be encoded as a JSON object (1pt)`(): Unit = {
//    val student = Student("Serhii", "Butko", 23)
//    val json = Json.Obj(Map("name" -> Json.Str("Serhii"), "surname" -> Json.Str("Butko"), "id" -> Json.Num(23)))
//    val encoder = implicitly[Encoder[Student]]
//    assert(encoder.encode(student) == json)
//  }
